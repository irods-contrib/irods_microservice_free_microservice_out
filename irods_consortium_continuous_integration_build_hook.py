...
def get_build_prerequisites_apt():
    return ['make', 'libssl-dev'] + get_build_prerequisites_all()

def get_build_prerequisites_yum():
    return ['openssl-devel'] + get_build_prerequisites_all()
...
def main(output_root_directory, irods_packages_root_directory):
    ...
    build_directory = tempfile.mkdtemp(prefix='irods_msifree_microservice_out')
